...
def inicio():
    system('clear')
    print('*'* 50)
    print('*'* 5 +' Bienvenido a mi recetero '+ '*' * 5)
    print('*'* 50)
    print('\n')
...
def crear_receta(ruta):
    ...
    while not existe:
        ...
        if not os.path.exists(ruta_nueva):
            ...
            print('Lo siento, esa receta ya la tienes en tu recetero')
...
def crear_categoria(ruta):
    ...
    while not existe:
        ...
        if not os.path.exists(ruta_nueva):
            ...
            print('Lo siento, esa categoria ya la tienes en tu recetero')
...
def volver_al_inicio():
    ...
    while eleccion_regresar.lower() != 'v':
        eleccion_regresar = input('\nPresione V para voler al inicio')
